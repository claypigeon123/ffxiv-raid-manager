...
export const Header = ({ setSidebarStatus }) => {
    ...
    return (
        <Navbar expand="lg" className="px-2 py-0 d-flex justify-content-around mb-3 border-bottom border-dodo shadow">
            <Button size="sm" variant="outline-light" onClick={() => { setSidebarStatus(true) }} className="d-lg-none ml-0 ml-lg-3">
            ...
            <div className="align-self-center d-flex py-0 pe-3">
                <div className="d-flex">
                    ...
                    <div className="align-self-center mr-4 d-none d-md-none d-sm-inline"> <span className={`text-dodo-bold`}>{user?.username}</span> </div>

                    <Button onClick={logout} className="btn-dodo d-none d-md-inline"> <FaSignOutAlt size="19" /> Logout </Button>
                    <Button size="sm" onClick={logout} className="btn-dodo d-md-none"> <FaSignOutAlt size="19" /> Logout </Button>
                </div>
            </div>
        </Navbar>
    )
